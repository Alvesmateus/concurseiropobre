                ...
                <div class="g-filter-widget-instance${fullWidthClass}" id="${this.widgetId}">
                    ...
                    <div class="g-panel" id="${this.widgetId}-panel">
                        <div class="g-mode-selector">
                            <label class="g-mode-option"><input type="radio" name="${this.widgetId}-search-mode" value="preciso" checked><span>BUSCA PRECISA</span></label>
                            <label class="g-mode-option"><input type="radio" name="${this.widgetId}-search-mode" value="amplo"><span>BUSCA AMPLA</span></label>
                        </div>
        ...
        toggleTag(item, type) {
            if (this.searchMode === 'preciso') {
                this.activeFilters.forEach((val, key) => {
                    if (val === type && key !== item) this.activeFilters.delete(key);
                });
            }
